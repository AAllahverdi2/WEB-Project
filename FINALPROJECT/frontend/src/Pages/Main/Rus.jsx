...
const Rus = () => {
  ...
  return (
    <div className='container'>
      ...
      <div  style={{fontSize:"20px"}}><strong>Yeni Rus Nesrleri</strong></div>
      <div className='boss'style={{width:"30%", height:"12px",backgroundColor:"#f6f6f6", }}></div>
      </div>
...
<select style={{width:"180px", height:"40px"}} name="" id="" onChange={(e)=>{
        ...
        <option value="AD">Абдель Селлу</option>
        <option value="AB">Абэ Тисато</option>
        ...
        <div className="row" style={{marginTop:"30px"}}>
            {
                product.map((item,index)=>{
                    if(item.categories=="Yeni Rus Nesriyyati"){
                        return(
                            <div className='col-xl-2 col-lg-4 col-md-6 mr-3 mb-3 Turkall'>
