        ...
        <div className='container modalScss' >
            ...
            <form onSubmit={formik.handleSubmit}>
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="modalFormInside">
                            <label htmlFor="yas"><strong>Yas</strong></label>
                            <input
                                id="yas"
                                name="yas"
                                type="text"
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                                value={formik.values.yas}
                            />
                            {formik.touched.yas && formik.errors.yas ? (
                                <div>{formik.errors.yas}</div>
                            ) : null}
                        </div>
